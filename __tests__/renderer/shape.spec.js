...
describe('shapes', () => {
  test('shape(name,context,attributes) creates SVG elements width specified attributes and mount it to group.', () => {
  ...
  test('ring() creates three circle elements tos simulate a ring.', () => {
    const renderer = createRenderer(600, 400);
